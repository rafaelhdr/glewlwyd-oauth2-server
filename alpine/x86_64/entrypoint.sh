...
then
    echo "You must have a pair of key/certificate an place it in '/var/glewlwyd/keys/private.key' and /var/glewlwyd/keys/public.pem'"
    echo "More information at https://github.com/rafaelhdr/glewlwyd-oauth2-server#define-keys-or-secrets"
fi
